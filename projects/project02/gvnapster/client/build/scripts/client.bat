...
set CLASSPATH=%APP_HOME%\lib\client.jar;%APP_HOME%\lib\info.jar;%APP_HOME%\lib\guava-23.0.jar;%APP_HOME%\lib\fx-gson-3.1.0.jar;%APP_HOME%\lib\gson-2.8.5.jar;%APP_HOME%\lib\jsr305-1.3.9.jar;%APP_HOME%\lib\error_prone_annotations-2.0.18.jar;%APP_HOME%\lib\j2objc-annotations-1.1.jar;%APP_HOME%\lib\animal-sniffer-annotations-1.14.jar;%APP_HOME%\lib\annotations-15.0.jar
